...
public class DbSeed implements CommandLineRunner {
    ...
    private void loadData() {
        ...
        //add teachers
        Teacher teacher1 = new Teacher("user", "name@host.domain", "password", "Firstname", "lastname", createdCountry1, 123l);
        ...
        //add lecture votes
        LectureVote lectureVote1 = new LectureVote();
        lectureVote1.setLecture(createdlecture1);
        lectureVote1.setTeacher(createdTeacher1);
        lectureVote1.setUpvote(true);
        LectureVote createdLectureVote1 = lectureVoteRepository.save(lectureVote1);
    }
}
